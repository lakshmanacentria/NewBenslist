...
//        setSupportActionBar(animToolbar);
        if (getIntent().getExtras() != null) {
            ...
            if (getIntent().getStringExtra("is_foodside") != null) {
                ...
                Log.e(TAG, "setweigts: " + getIntent().getStringExtra("is_foodside"));
                is_from_side = getIntent().getStringExtra("is_foodside");
                if (is_from_side.equalsIgnoreCase("charitygooddsdonate")) {
                    setTitle("CharityDetailActivity");
                } else {
        ...
        switch (v.getId()) {
            case R.id.btn_donateknow:
                if (getIntent().getStringExtra("is_foodside") != null) {
                    ...
                    if (is_from_side.equalsIgnoreCase("charitygooddsdonate")) {
                        startActivity(new Intent(this, CharityDonateActivity.class).putExtra("Ref_no", ref_no).putExtra("is_foodside", getIntent().getStringExtra("charitygooddsdonate")));
