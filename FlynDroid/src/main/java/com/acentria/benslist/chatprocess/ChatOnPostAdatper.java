...
public class ChatOnPostAdatper extends RecyclerView.Adapter<ChatOnPostAdatper.ViewHolder> {
    private String TAG = ChatOnPostAdatper.class.getName(), img_url;
    private Context mcontext;
    private List<ChatMessageResponse> mlist=new ArrayList<>();
    private boolean is_chat_bayer;


    public ChatOnPostAdatper(Context context, List<ChatMessageResponse> list, boolean is_chat_bayer) {
